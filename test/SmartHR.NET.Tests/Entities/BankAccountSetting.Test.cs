...
/// <summary><see cref="BankAccountSetting"/>の単体テスト</summary>
public class BankAccountSettingTest
{
    /// <summary>口座情報APIのサンプルレスポンスJSON</summary>
    ...
    {
        // Arrange - Act
        var entity = JsonSerializer.Deserialize<BankAccountSetting>(Json, JsonConfig.Default);
